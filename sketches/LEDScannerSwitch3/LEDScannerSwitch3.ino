...
boolean wasSwitchPressed = false;
void loop()
{
  ...
  // is the switch pressed when it wasn't before?
  if(digitalRead(6) == LOW && !wasSwitchPressed)
  {
    // remember the switch was pressed 
  ...
  {
    // remember the switch is not pressed
    wasSwitchPressed = false;
    
//    uncomment this delay :-)          
//    delay(100);
